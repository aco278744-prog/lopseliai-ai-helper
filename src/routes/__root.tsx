  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Įvyko klaida. Pabandykite atnaujinti puslapį arba grįžti į pradžią.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lopšeliai — DI mokymai ikimokyklinio ugdymo įstaigoms" },
      {
        name: "description",
        content:
          "Personalus dirbtinio intelekto kursas Lietuvos lopšelių-darželių darbuotojams. Paruoštos užklausos ir šablonai kasdieniam darbui.",
      },
      { name: "author", content: "Lopšeliai" },
